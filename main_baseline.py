...
# It is used for Joint Training and Fine-Tuning experiments.
...
def baseline_train_eval_model(
        model, train_dict, val_dict, test_dict, criterion, optimizer,
        experiences_targets, batch_size, n_epochs, smoothing_window,
        early_stop_patience=np.inf, early_stop_margin=0, eval_every=1,
